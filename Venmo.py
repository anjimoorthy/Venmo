...
if __name__ == "__main__":
    ...
    #get_users_csv("/Data/venmo-4.csv", "/Data/users-4.csv", 7000000)
    get_payments_csv("/Data/venmo-4.csv", "/Data/payments-4.csv", 7000000)
    #check_total_num_rows("/Data/venmo-1.csv")
